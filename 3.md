...
[Download File](https://drive.google.com/file/d/1LWjHGvmYsvEbsMq-6U64RnvT_qFaFc6w/view?usp=sharing)

## You will need:

- Add this line at the end of the file `"modules_statuses.json"`
`"Labels": true`
- install the module.
- In the menu use the second menu option `print_labels (Enhanced)` (The first menu option doesnt work)
...
### Troubleshooting
#### Common Issues
- **Preview not loading**: Check browser console for JavaScript errors
- **Print quality issues**: Ensure proper barcode dimensions in settings
- **Image not showing**: Verify image URL accessibility and CORS settings
- **Currency format wrong**: Check currency settings in business configuration
...
---
[← Previous: Stock Report Filter Enhancement](2.md)  |  [Next →: Due Collections Feature](4.md)