...
Usage
Access Enhanced Labels: Navigate to Product > Print Labels (Enhanced) in the sidebar menu

Add Products: Use the search field to find and add products to your label batch
